        ...
        <Row className="mb-3">
          <Col md={6}>
            <Form.Group>
              ...
              <Form.Control value={landingPage} onChange={(e) => setLandingPage(e.target.value)} required/>
            </Form.Group>
          </Col>
          <Col md={6}>
            <Form.Group>
              <Form.Label>🎯 CTA Button Label</Form.Label>
              <Form.Control value={ctaLabel} onChange={(e) => setCtaLabel(e.target.value)} required />
            </Form.Group>
          </Col>
        </Row>
