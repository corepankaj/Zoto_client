...
import { Form, Button, Row, Col, Card, InputGroup, Tab, Tabs, Modal } from 'react-bootstrap';
import { BsClock, BsCalendar3 } from 'react-icons/bs';
import Select from 'react-select';
import axios from 'axios';

// Optional: you can install a WYSIWYG editor like react-quill
        ...
        <Card className="p-4 m-4 shadow-sm">
            ...
            <Form onSubmit={handleSubmit}>
                <Tabs defaultActiveKey="tab1" className="mb-3">
                    {/* Tab 1 */}
                    <Tab eventKey="tab1" title="Campaign Details">
                        <Row className="mb-3">
                            <Col md={6}>
                                <Form.Group>
                                    <Form.Label>Campaign Name</Form.Label>
                                    <Form.Control value={campaignName} onChange={(e) => setCampaignName(e.target.value)} required />
                                </Form.Group>
                            </Col>
                            <Col md={6}>
                                <Form.Group>
                        ...
                        <Row className="mb-3">
                            <Col md={6}>
                                <Form.Group>
                                    ...
                                    <Select isMulti options={channelOptions} value={channels} onChange={setChannels} required />
                                </Form.Group>
                            </Col>
                            <Col md={6}>
                                <Form.Group>
                                    <Form.Label>Status</Form.Label>
                                    <Form.Select value={status} onChange={(e) => setStatus(e.target.value)} disabled>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control as="textarea" rows={2} value={goal} onChange={(e) => setGoal(e.target.value)} required />
                        </Form.Group>
                    </Tab>

                    {/* Tab 2 */}
                    <Tab eventKey="tab2" title="Audience Details">
                        <Row className="mb-3">
                            <Col md={6}>
                                <Form.Group>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Select isMulti options={segmentOptions} value={segments} onChange={setSegments} required />
                        </Form.Group>
                    </Tab>

                    {/* Tab 3 */}
                    <Tab eventKey="tab3" title="Creative & Landing">
                        ...
                        <Form.Group className="mb-4">
                            ...
                            <ReactQuill value={additionalContent} onChange={setAdditionalContent} />
                        </Form.Group>
                        ...
                        <Row className="mb-3">
                            <Col md={6}>
                                <Form.Group>
                                    ...
                                    <Form.Control value={landingPage} onChange={(e) => setLandingPage(e.target.value)} required disabled />
                                </Form.Group>
                            </Col>
                            <Col md={6}>
                                <Form.Group>
                                    <Form.Label>🎯 CTA Button Label</Form.Label>
                                    <Form.Control value={ctaLabel} onChange={(e) => setCtaLabel(e.target.value)} required disabled />
                                </Form.Group>
                            </Col>
                        </Row>
                        <Button variant="primary" onClick={() => setShowPreview(true)} style={{ marginBottom: '25px' }}>Preview</Button>
                    </Tab>

                    {/* Tab 4 */}
                    <Tab eventKey="tab4" title="Schedule Campaign">
                        <Row className="mb-3">
                            <Col md={6}>
                                <Form.Group>
                        ...
                        <Button type="submit" variant="primary">Schedule Campaign</Button>
                    </Tab>
                </Tabs>
